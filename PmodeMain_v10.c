...
double e0;
{
	...
	double w,wcheck,o[2],wi,aR,bR,gR,hR,kR,n,Y1,Y2,Z,DZ,DDZ,VZ,Ar1,Ar2,Ai1,Ai2,ar,ai,Ar[2],Ai[2],Br[2],Bi[2],AM,AMmin=1e10;
...
int main()
{
	...
	system("title Advanced codes P-mode_v10     for Windows");
